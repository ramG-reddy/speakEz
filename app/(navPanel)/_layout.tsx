...
export default function NavPanelLayout() {
  ...
  return (
    <View className="flex-1 flex-row">
      ...
      >
        <View>
          <Text className="max-lg:text-4xl lg:text-7xl font-semibold">{currentTime}</Text>
        </View>
        <NavPatch />
        <Pressable onPress={() => router.push("../(home)")}>
          <View className="w-full h-full justify-center items-center bg-blue-500 rounded-lg shadow-md">
